...
HD_PWD='C:/Users/Dell-/Desktop/AUC/AUC semester 6/Computer Architecture/RISCV32ICM CPU/RiscV32ICM-CPU/RISV32ICM/RISV32ICM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SCCPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SCCPU.tcl
